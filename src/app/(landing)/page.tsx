  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden grayscale">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full h-screen px-4">
        <h1 className="text-4xl md:text-7xl text-white font-normal text-center">
          SPELLBOUND HAIR DESIGN
        </h1>
        <hr className="border-white w-2/3 my-4 md:my-8 mt-1" />
        ...
        <div className="mt-8 flex flex-col md:flex-row lg:flex-row xl:flex-row gap-6 items-center text-sm ">
          <div className="p-1 border border-white w-auto">
            <button className=" py-3 px-10 font-mono bg-white text-black font-semibold hover:bg-gray-200 transition duration-300 shadow-md">
              647-272-9773
            </button>
          </div>
          <div className="p-1 border border-white">
            <button className="font-mono px-3 py-3 bg-white text-black font-semibold hover:bg-gray-200 transition duration-300 shadow-md">
              sb.hair@hotmail.com
            </button>
          </div>
        </div>
      ...
      <section className="relative w-full min-h-screen bg-black flex items-center justify-center text-white px-4 py-10">
        <div className="border border-white w-full max-w-6xl mx-4">
          <div className="bg-black flex flex-col md:flex-row items-center py-10 text-white w-full">
            ...
            <div className="w-full md:w-1/2 px-4 md:px-10 text-center flex flex-col justify-center items-center">
              <div className="w-full max-w-md">
                <h2 className="text-3xl md:text-5xl mb-2">PUSHING OUR CRAFT FURTHER</h2>
                <hr className="border-white w-full my-3"/>
                <p className="text-center text-base md:text-lg font-light font-mono">
